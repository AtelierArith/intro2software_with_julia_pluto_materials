...
下記の項目を反復関数系 (iterated function system
) によって作成する.

- [バーンズリーのシダ](https://ja.wikipedia.org/wiki/%E3%83%90%E3%83%BC%E3%83%B3%E3%82%BA%E3%83%AA%E3%83%BC%E3%81%AE%E3%82%B7%E3%83%80)

反復関数系を定義するアフィン変換は Wikipedia にて紹介されているパラメータを元に設定している
"""
...
@benchmark generate_points($transforms, $catdist) samples=100

# ╔═╡ 4bdb58fb-e71a-466b-bd99-77b0fda6d6cd
@benchmark generate_points!(xs, ys, tfm, d) samples=100 setup = begin
	xs = Vector{Float64}(undef, 100000)
	ys = Vector{Float64}(undef, 100000)
	tfm = transforms
	d = catdist
end
...
manifest_format = "2.0"
project_hash = "3ac545147e9e07bdfdb6035f2a35463a51620f54"
